...
if(isset($_POST['search_se'])){
    $sid1 = $_POST['sid'];
    header('Location: updatemarks.php?sid='."$sid1");
    $DisplayForm = False;
...
if(isset($_POST['update_mark'])){
    ...
    $db= $con;
        ...
        $sql = "UPDATE `marks` SET `mark1`='$mark1',`mark2`='$mark2',`mark3`='$mark3',`mark4`='$mark4',`mark5`='$mark5',`mark6`='$mark6',`mark7`='$mark7',`updated_by`='$update' WHERE `std_id`='$id'" ;
           $result = $db->query($sql);
        
           if($result== true){ 
            header('Location: viewmarks.php?sid='."$id");
           }else{
            header('Location: updatemarks.php?error');
           }
           }
...
<head>
    ...
    <title>SIMS | Update Marks | MS</title>
    ...
    <div class="container">
        <div class="section-content">
            <div class="col text-center" data-aos="fade-up">
                ...
                <br>
                <br>
                <h2 class="section-title"><b>Update Marks</b></h2>    
            </div>
...
<h4 class="section-title"><u>Marks</u></h4> 
					 ...
					 <label><?php echo $data['sub1']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark1" value="<?php echo $data['mark1']??''; ?>"  id="mark1" placeholder="Subject 1"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub2']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark2" value="<?php echo $data['mark2']??''; ?>"  id="mark1" placeholder="Subject 2"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub3']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark3" value="<?php echo $data['mark3']??''; ?>"  id="mark1" placeholder="Subject 3"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub4']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark4" value="<?php echo $data['mark4']??''; ?>"  id="mark1" placeholder="Subject 4"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub5']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark5" value="<?php echo $data['mark5']??''; ?>"  id="mark1" placeholder="Subject 5"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub6']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark6" value="<?php echo $data['mark6']??''; ?>"  id="mark1" placeholder="Subject 6"  min="0" value="0" step="0.01">
                            </div>
                            <div class="col-md-6">
					 <label><?php echo $data['sub7']??''; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                            <input type="number"style="text-align:center"name="mark7" value="<?php echo $data['mark7']??''; ?>" id="mark1" placeholder="Subject 7"  min="0" value="0" step="0.01">
                            </div>
                            <div class=" col-md-8 offset-md-2 contact-form-holder mt-4 text-center" data-aos="fade-up">
<hr style="height:2px;border-width:0;color:black;background-color:white">
                                <div class="col-md-12 text-center">
                                ...
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="update_mark">Update Record</button>
            </div>
